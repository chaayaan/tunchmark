...
<aside class="nb-sidebar" id="nbSidebar">
    ...
    <nav class="nb-nav">
        ...
        <!-- Inventory -->
        <div class="nb-group">
            <div class="nb-group-toggle <?= in_array(basename($_SERVER['PHP_SELF']), ['inventory.php','stock_in.php','stock_out.php']) ? 'nb-active' : '' ?>"
                 data-target="nbInventory">
                <i class="fas fa-boxes-stacked nb-gi"></i>
                <span>Inventory</span>
                <i class="fas fa-chevron-down nb-chevron"></i>
            </div>
        ...
        <!-- Manage -->
        <div class="nb-group">
            <div class="nb-group-toggle <?= in_array(basename($_SERVER['PHP_SELF']), ['users.php','account.php','manage_licenses.php','buyers.php','suppliers.php']) ? 'nb-active' : '' ?>"
                 data-target="nbManage">
                <i class="fas fa-gear nb-gi"></i>
                <span>Manage</span>
                <i class="fas fa-chevron-down nb-chevron"></i>
            </div>
            <div class="nb-submenu <?= in_array(basename($_SERVER['PHP_SELF']), ['users.php','account.php','manage_licenses.php','buyers.php','suppliers.php']) ? 'nb-open' : '' ?>"
                 id="nbManage">
                ...
                <a class="nb-link <?= basename($_SERVER['PHP_SELF']) == 'buyers.php' ? 'nb-active' : '' ?>"
                   href="buyers.php">
                    <i class="fas fa-cart-shopping"></i><span>Buyers</span>
                </a>
                <a class="nb-link <?= basename($_SERVER['PHP_SELF']) == 'suppliers.php' ? 'nb-active' : '' ?>"
                   href="suppliers.php">
