...
$jointCode     = '';
$isHallmark    = false;
$report_images = [];   // tunch: up to 2
$report_image  = null; // hallmark: 1
...
<head>
    ...
    <style>
        *, *::before, *::after {
        ...
        .scale-wrapper { width: 100%; height: 100%; display: flex; justify-content: center; align-items: flex-start; }
        @media (min-width: 700px) { .scale-wrapper { height: auto; align-items: flex-start; } }
        ...
        .hallmark-report-title {
            text-align: center; color: #3eb1e3;
            font-size: 30px; font-weight: bold;
            margin: 0; padding: 2px 0; letter-spacing: 2px; line-height: 1;
            font-family: 'Times New Roman', Times, serif;
        }
